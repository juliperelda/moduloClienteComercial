  ...
  return (
    <>
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
        <PieChart className='graficoAnilloCapacidad' width={400} height={250}>
          <Legend className='legendGrafico' iconType="circle" layout="vertical" align="left" verticalAlign="top" />
          <Pie
            className='pie'
            data={data}
            cx={100}
